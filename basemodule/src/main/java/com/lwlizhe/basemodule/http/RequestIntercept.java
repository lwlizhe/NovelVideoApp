package com.lwlizhe.basemodule.http;

import android.support.annotation.NonNull;

import com.lwlizhe.basemodule.utils.ZipHelper;
...
import static com.lwlizhe.basemodule.utils.CharactorHandler.jsonFormat;
...
public class RequestIntercept implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (request.body() != null) {
            ...
            Logger.t("Request").w("request.body() == null");
        }


        //打印url信息
        Logger.t("Request").w("Sending Request %s on %n Params --->  %s%n Connection ---> %s%n Headers ---> %s", request.url()
        ...
        //打印响应时间
        Logger.t("Response").w("Received response  in %.1fms%n%s", (t2 - t1) / 1e6d, originalResponse.headers());
        ...
        Logger.t("Result").w(jsonFormat(bodyString));
