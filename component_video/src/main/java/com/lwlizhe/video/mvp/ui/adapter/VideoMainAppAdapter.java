...
public class VideoMainAppAdapter extends RecyclerView.Adapter<BaseHolder> {

    private DilidiliIndexEntity.DataBean info;
    ...
    public void setDilidiliInfo(DilidiliIndexEntity.DataBean info) {
    ...
    public void onBindViewHolder(@NonNull BaseHolder holder, int position) {
        switch (getItemViewType(position)){
            case TYPE_BANNER:
                holder.setData(info.getCarousel(), position);
                break;
            case TYPE_WEEK:
                holder.setData(info.getWeekList(), curWeekTagPos);
                break;
            case TYPE_RECENT:
                holder.setData(info.getEditorPick(), position);
                break;
            case TYPE_RECOMMEND:
                holder.setData(info.getUgcPick(), position);
                break;
        }
    }
