...
import com.lwlizhe.novelvideoapp.video.mvp.ui.adapter.holder.VideoMainRecentHolder;
import com.lwlizhe.novelvideoapp.video.mvp.ui.adapter.holder.VideoMainRecommendHolder;
import com.lwlizhe.novelvideoapp.video.mvp.ui.adapter.holder.VideoMainWeekHolder;

/**
 * Created by Administrator on 2018/7/3 0003.
 */

public class VideoMainAdapter extends RecyclerView.Adapter<BaseHolder<Object>> {
    ...
    @NonNull
    @Override
    public BaseHolder<Object> onCreateViewHolder(@NonNull ViewGroup parent, final int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(getLayoutId(viewType), parent, false);
        BaseHolder<Object> mHolder = getHolder(view, viewType);
    ...
    public void onBindViewHolder(@NonNull BaseHolder<Object> holder, int position) {
        switch (getItemViewType(position)){
            case TYPE_BANNER:
                holder.setData(info.getScheudleBanners(), position);
                break;
            case TYPE_WEEK:
            ...
            case TYPE_RECENT:
                ...
                break;
            case TYPE_RECOMMEND:
                holder.setData(info.getScheduleRecommands(), position);
                break;
        }
    }
